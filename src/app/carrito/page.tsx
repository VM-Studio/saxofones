  ...
  <div className="w-full flex flex-col lg:flex-row gap-12 items-start justify-between">
          ...
          <div className="w-full max-w-md bg-[#eee9e1]/80 rounded-lg shadow-lg p-8 flex flex-col gap-6 border border-[#e0d6c8]">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://wa.me/5491123456789" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition">
