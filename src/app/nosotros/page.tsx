...
import Tienda from "../../../public/drbrass-tiend.jpeg"
  ...
  return (
    <main className="w-full bg-drblack py-6 sm:py-10 px-2 sm:px-4 text-drgray flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl flex flex-col gap-4 sm:gap-6 items-center px-4">
        <Image src={Tienda} alt="Tienda DR BRASS Rosario" width={600} height={256} className="w-full h-auto mb-4 sm:mb-6 rounded shadow-dr border-2 border-drgold object-cover" />
