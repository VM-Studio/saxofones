        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            <div className="space-y-3">
              {[
                { text: "Expertos con 20+ años de experiencia" },
                { text: "Asesoramiento personalizado" },
                { text: "Consulta gratuita sin compromiso" },
                { text: "Seguimiento post-compra" },
              ].map((item, i) => (
                <div
                  key={i}
                  className="group flex items-center gap-4 bg-white border border-gold/10 hover:border-gold/30 p-4 md:p-5 transition-all duration-300 hover:-translate-y-0.5"
                >
                  <div className="w-8 h-px bg-gold group-hover:w-12 transition-all duration-300 shrink-0"></div>
