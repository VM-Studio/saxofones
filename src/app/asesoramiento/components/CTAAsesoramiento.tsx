      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="space-y-10 md:space-y-12">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-sm md:text-base text-cream/50 max-w-xl mx-auto leading-relaxed">
          ...
          <div className="pt-8 border-t border-cream/10">
            <span className="text-cream/40 text-xs sm:text-sm tracking-wide">Más de 500 clientes satisfechos cada año</span>
          </div>
        </div>
      </div>
    </section>
