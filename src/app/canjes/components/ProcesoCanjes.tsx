      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="space-y-px bg-gold/10">
          {pasos.map((paso, idx) => (
            <div
              key={idx}
              className="group bg-white hover:bg-cream-dark/30 p-6 md:p-8 transition-all duration-300"
            >
              <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-8">
                <span className="font-serif text-3xl md:text-4xl font-bold text-gold/30 group-hover:text-gold transition-colors duration-300 shrink-0">
                  0{paso.numero}
                </span>

                <div className="flex-1">
                  <h3 className="text-lg md:text-xl font-serif font-bold text-brown-dark mb-2">
                    {paso.titulo}
                  </h3>
