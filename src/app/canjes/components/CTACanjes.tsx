        ...
        <div className="text-center space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 py-8">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-cream font-semibold">Evaluación en 1 día</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-cream font-semibold">Mejor valor del mercado</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-cream font-semibold">Proceso transparente</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 pt-8 border-t border-cream/20">
            ...
            <span className="text-cream/90">Hemos evaluado más de 2000 instrumentos en 20 años</span>
          </div>
        </div>
      </div>
    </section>
