      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="space-y-10 md:space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gold/10">
            {[
              { label: "Evaluación en 1 día" },
              { label: "Mejor valor del mercado" },
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <Link
              href="/productos"
              className="group inline-flex items-center gap-3 border border-cream/30 text-cream hover:bg-cream/5 text-sm sm:text-base font-medium tracking-wide uppercase transition-all duration-300 px-7 sm:px-8 py-3.5 sm:py-4"
            >
              Ver Catálogo
            </Link>
          </div>
          ...
          <div className="pt-8 border-t border-cream/10">
            <span className="text-cream/40 text-xs sm:text-sm tracking-wide">Hemos evaluado más de 2000 instrumentos en 20 años</span>
          </div>
        </div>
      </div>
    </section>
