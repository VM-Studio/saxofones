        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start space-y-6 md:space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold text-brown-dark leading-tight tracking-tight">
              Garantía <span className="text-gold">Total</span>
            </h1>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="group bg-white border border-gold/10 hover:border-gold/30 p-3 md:p-4 transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="w-8 h-px bg-gold mb-3 group-hover:w-12 transition-all duration-300"></div>
                  <h3 className="font-serif font-bold text-brown-dark text-xs md:text-base mb-1">{item.title}</h3>
                  <p className="text-[10px] md:text-sm text-charcoal/60">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
